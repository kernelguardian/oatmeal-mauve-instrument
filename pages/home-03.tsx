                ...
                demo={
                  <Screenshot wallpaper="blue" placement="bottom-right">
                    ...
                    <img
                      width={1500}
                      height={680}
                      src="https://assets.tailwindplus.com/screenshots/1.webp?left=1500&top=680&color=mauve"
                      alt=""
              ...
              <Feature
                ...
                demo={
                  <Screenshot wallpaper="purple" placement="top-left">
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1500&bottom=680&color=mauve"
                      alt=""
                      width={1500}
                      height={680}
                      className="bg-black/75 not-dark:hidden max-sm:hidden lg:hidden"
              ...
              <Feature
                ...
                demo={
                  <Screenshot wallpaper="brown" placement="bottom-left">
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1500&top=680&color=mauve"
                      alt=""
                      width={1500}
                      height={680}
                      className="bg-black/75 not-dark:hidden max-sm:hidden lg:hidden"
