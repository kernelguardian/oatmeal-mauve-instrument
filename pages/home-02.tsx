          ...
          demo={
            <>
              ...
              <img
                ...
                src="https://assets.tailwindplus.com/screenshots/1.webp?top=900&color=mauve"
                alt=""
                width="3440"
                height="1500"
              />
              ...
              <img
                ...
                src="https://assets.tailwindplus.com/screenshots/1.webp?top=1200&color=mauve"
                alt=""
                width="3440"
                height="1500"
              />
              ...
              <img
                ...
                src="https://assets.tailwindplus.com/screenshots/1.webp?top=1500&color=mauve"
                alt=""
                width="3440"
                height="1500"
              />
              ...
              <FeatureThreeColumnWithDemos
                demo={
                  <Screenshot wallpaper="blue" placement="bottom-right">
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?left=1200&top=736&color=mauve"
                      alt=""
                      width={1200}
                      height={736}
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?left=1800&top=736&color=mauve"
                      alt=""
                      width={1800}
                      height={736}
              ...
              <FeatureThreeColumnWithDemos
                demo={
                  <Screenshot wallpaper="purple" placement="top-left">
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1200&bottom=736&color=mauve"
                      alt=""
                      width={1200}
                      height={736}
                      className="bg-black/75 not-dark:hidden sm:hidden"
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1800&bottom=736&color=mauve"
                      alt=""
                      width={1800}
                      height={736}
                      className="bg-black/75 not-dark:hidden max-sm:hidden lg:hidden"
              ...
              <FeatureThreeColumnWithDemos
                demo={
                  <Screenshot wallpaper="brown" placement="bottom-left">
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1200&top=736&color=mauve"
                      alt=""
                      width={1200}
                      height={736}
                      className="bg-black/75 not-dark:hidden sm:hidden"
                    ...
                    />
                    <img
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1800&top=736&color=mauve"
                      alt=""
                      className="bg-black/75 not-dark:hidden max-sm:hidden lg:hidden"
                      width={1800}
                      height={736}
